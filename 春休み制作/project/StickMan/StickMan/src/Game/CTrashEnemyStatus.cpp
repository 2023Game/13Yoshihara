...
#define NORMAL_KNOCKBACK_SPEED 0.75f * 60.0f * 2.0f	// ノックバック速度
...
#define PUNISHER_BASE_MOVE_SPEED 0.75f * 60.0f			// 移動速度
#define PUNISHER_JUMP_SPEED 1.5f						// ジャンプ速度
#define PUNISHER_KNOCKBACK_SPEED 0.75f * 60.0f * 2.0f	// ノックバック速度
